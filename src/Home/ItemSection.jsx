    ...
    return (
        <div className="mx-12 my-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-8">
                {
                    items.map((item, idx) => <div key={item._id} className="border-2 rounded-lg border-emerald-900 p-8 hover:border-none flex justify-center">
                        <div className="">
                            ...
                            <Link to={`/view_details/${idx + 1}`} className="flex justify-center my-2"><button className="text-white font-display bg-emerald-900 px-4 py-2">View Details</button></Link>
                        </div>
                    </div>)
                }
            </div>
